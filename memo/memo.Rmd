---
title: "Analyzing squirrel behavior in Central Park"
author: "Cate, Dillon, Tomas"
...
```{r leaflet-map, fig.alt = "Map showing each squirrel observed in the dataset. The map has markers in the squirrel's primary color showing where each squirrel was observed in Central Park."}
